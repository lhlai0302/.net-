...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:stuSysConnectionString %>" SelectCommand="SELECT [week], [firstClass], [secondClass], [thirdClass], [fourthClass], [fifthClass] FROM [personalCourse] WHERE (([stuNo] = @stuNo) AND ([year] = @year) AND ([term] = @term))">
        <SelectParameters>
            <asp:Parameter DefaultValue="201611701208" Name="stuNo" Type="String" />
