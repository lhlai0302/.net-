...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:GridView runat="server" ID="courseView" AutoGenerateColumns="False" DataKeyNames="courseId" class="table table-bordered table-hover" AllowPaging="true" PageSize="15" OnPageIndexChanging="Course_PageIndexChanging">
        <Columns>
            <asp:BoundField DataField="courseId" HeaderText="课程编号" InsertVisible="False" ReadOnly="True" SortExpression="courseId" />
            ...
            <asp:BoundField DataField="courseProperties" HeaderText="课程性质" SortExpression="courseProperties" />
            <asp:BoundField DataField="beginEnd" HeaderText="起止周" SortExpression="beginEnd" />
            <asp:BoundField DataField="totalTime" HeaderText="总学时" SortExpression="totalTime" />
